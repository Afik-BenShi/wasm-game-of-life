...
[[cheerp::genericjs]] int conwayKernel(int **board, int iloc, int jloc, int rows, int cols)
{
    ...
    // std::cout  << " range: " << iMinLoc << ", " << iMaxLoc << ", " << jMinLoc << ", " << jMaxLoc;
...
[[cheerp::genericjs]] int **getBoardDiff(int **prev, int **next, int rows, int cols)
{
